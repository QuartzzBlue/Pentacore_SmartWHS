                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li> <!-- 상품 입출고 -->
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-note menu-icon"></i><span class="nav-text">Product Management</span>
                        </a>
                    ...
                    <li> <!-- 지게차 관리 -->
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-speedometer menu-icon"></i><span class="nav-text">Forklift Management</span>
                        </a>
                    </li>
                    <li> <!-- 솔루션 -->
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-globe-alt menu-icon"></i><span class="nav-text">Solution</span>
                        </a>
                    </li>
                </ul>
            </div>
