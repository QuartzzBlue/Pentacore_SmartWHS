...
create table item(itemid varchar(10), wareid varchar(10), itemname varchar(30), warename varchar(30), itemcate varchar(30), itemprice double, itemstock int(1), itemweightpb double, itemqtypb int(1), itemloc varchar(10));
