...
- 6주 (3.23~4.30)
- 1주차 (3월 23일 ~ 3월 29일) : 프로젝트 기획 및 요구사항 정의, RFP, 기획안, 제안서 작성/ERD 작성/ UI 설계서(UI 시나리오 작성) / 아키텍처 설계 / 현행 업무,시스템 분석
- 2주차 (3월 30일 ~ 4월 5일) : 데이터베이스 구축, Hadoop 서버 구축, 상세화면 설계
- 3주차 (4월 6일 ~ 4월 12일) : 개발 
- 4주차 (4월 13일 ~ 4월 19일) : R 을 활용한 솔루션 도출 및 웹 시각화
- 5주차 (4월 20일 ~ 4월 30일) : 통합 구현 및 통합 테스트
